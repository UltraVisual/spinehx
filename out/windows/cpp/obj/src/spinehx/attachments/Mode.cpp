...
::spinehx::attachments::Mode Mode_obj::backward;

::spinehx::attachments::Mode Mode_obj::backwardLoop;

::spinehx::attachments::Mode Mode_obj::forward;

::spinehx::attachments::Mode Mode_obj::forwardLoop;

::spinehx::attachments::Mode Mode_obj::pingPong;

::spinehx::attachments::Mode Mode_obj::random;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("spinehx.attachments.Mode"), hx::TCanCast< Mode_obj >,sStaticFields,sMemberFields,
	&__Create_Mode_obj, &__Create,
	&super::__SGetClass(), &CreateMode_obj, sMarkStatics, sVisitStatic);
}
