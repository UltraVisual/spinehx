...
int fillColor = __o_fillColor.Default(-1);
{
	...
	HX_STACK_LINE(45)
	if (((bool((width < (int)1)) || bool((width < (int)1))))){
		HX_STACK_LINE(45)
		this->__handle = null();
	}
	else{
		...
		HX_STACK_LINE(61)
		this->__handle = ::flash::display::BitmapData_obj::nme_bitmap_data_create(width,height,flags,(int(fillColor) & int((int)16777215)),alpha,gpuMode);
	}
}
;
	return null();
...
bool BitmapData_obj::get_transparent( ){
	HX_STACK_PUSH("BitmapData::get_transparent","flash/display/BitmapData.hx",651);
	HX_STACK_THIS(this);
	HX_STACK_LINE(651)
...
int BitmapData_obj::get_height( ){
	HX_STACK_PUSH("BitmapData::get_height","flash/display/BitmapData.hx",650);
	HX_STACK_THIS(this);
	HX_STACK_LINE(650)
	return ::flash::display::BitmapData_obj::nme_bitmap_data_height(this->__handle);
}
...
int BitmapData_obj::get_width( ){
	HX_STACK_PUSH("BitmapData::get_width","flash/display/BitmapData.hx",649);
	HX_STACK_THIS(this);
	HX_STACK_LINE(649)
	return ::flash::display::BitmapData_obj::nme_bitmap_data_width(this->__handle);
}
...
::flash::geom::Rectangle BitmapData_obj::get_rect( ){
	HX_STACK_PUSH("BitmapData::get_rect","flash/display/BitmapData.hx",648);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
{
		HX_STACK_PUSH("BitmapData::__loadFromBytes","flash/display/BitmapData.hx",580);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bytes,"bytes");
		HX_STACK_ARG(rawAlpha,"rawAlpha");
		HX_STACK_LINE(580)
		this->__handle = ::flash::display::BitmapData_obj::nme_bitmap_data_from_bytes(bytes,rawAlpha);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::__drawToSurface","flash/display/BitmapData.hx",566);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(566)
		::flash::display::BitmapData_obj::nme_render_surface_to_surface(surface,this->__handle,matrix,colorTransform,blendMode,clipRect,smoothing);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::unlock","flash/display/BitmapData.hx",559);
		HX_STACK_THIS(this);
...
bool copySource = __o_copySource.Default(false);
	HX_STACK_PUSH("BitmapData::threshold","flash/display/BitmapData.hx",408);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setVector","flash/display/BitmapData.hx",386);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(392)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_array(this->__handle,rect,pixels);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::setPixels","flash/display/BitmapData.hx",376);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
		HX_STACK_ARG(pixels,"pixels");
		HX_STACK_LINE(378)
		...
		HX_STACK_LINE(380)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_bytes(this->__handle,rect,pixels,pixels->position);
		HX_STACK_LINE(381)
...
{
		HX_STACK_PUSH("BitmapData::setPixel32","flash/display/BitmapData.hx",369);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(color,"color");
		HX_STACK_LINE(369)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_pixel32(this->__handle,x,y,color);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::setPixel","flash/display/BitmapData.hx",362);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(color,"color");
		HX_STACK_LINE(362)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_pixel(this->__handle,x,y,color);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::setFormat","flash/display/BitmapData.hx",355);
		HX_STACK_THIS(this);
		HX_STACK_ARG(format,"format");
		HX_STACK_LINE(355)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_format(this->__handle,format);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::setFlags","flash/display/BitmapData.hx",347);
		HX_STACK_THIS(this);
		HX_STACK_ARG(flags,"flags");
		HX_STACK_LINE(347)
		::flash::display::BitmapData_obj::nme_bitmap_data_set_flags(this->__handle,flags);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::scroll","flash/display/BitmapData.hx",340);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_LINE(340)
		::flash::display::BitmapData_obj::nme_bitmap_data_scroll(this->__handle,x,y);
	}
return null();
}
...
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::perlinNoise","flash/display/BitmapData.hx",325);
	HX_STACK_THIS(this);
...
int channelOptions = __o_channelOptions.Default(7);
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::noise","flash/display/BitmapData.hx",318);
	HX_STACK_THIS(this);
	HX_STACK_ARG(randomSeed,"randomSeed");
...
{
		HX_STACK_LINE(318)
		::flash::display::BitmapData_obj::nme_bitmap_data_noise(this->__handle,randomSeed,low,high,channelOptions,grayScale);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::lock","flash/display/BitmapData.hx",311);
		HX_STACK_THIS(this);
	}
return null();
}
...
Array< int > BitmapData_obj::getVector( ::flash::geom::Rectangle rect){
	HX_STACK_PUSH("BitmapData::getVector","flash/display/BitmapData.hx",265);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_LINE(267)
	...
	HX_STACK_LINE(274)
	::flash::display::BitmapData_obj::nme_bitmap_data_get_array(this->__handle,rect,result);
	HX_STACK_LINE(281)
	return result;
}
...
::flash::utils::ByteArray BitmapData_obj::getPixels( ::flash::geom::Rectangle rect){
	HX_STACK_PUSH("BitmapData::getPixels","flash/display/BitmapData.hx",230);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_LINE(232)
	::flash::utils::ByteArray result = ::flash::display::BitmapData_obj::nme_bitmap_data_get_pixels(this->__handle,rect);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(233)
	if (((result != null()))){
		HX_STACK_LINE(233)
...
int BitmapData_obj::getPixel32( int x,int y){
	HX_STACK_PUSH("BitmapData::getPixel32","flash/display/BitmapData.hx",223);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_LINE(223)
	return ::flash::display::BitmapData_obj::nme_bitmap_data_get_pixel32(this->__handle,x,y);
}
...
int BitmapData_obj::getPixel( int x,int y){
	HX_STACK_PUSH("BitmapData::getPixel","flash/display/BitmapData.hx",216);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_LINE(216)
	return ::flash::display::BitmapData_obj::nme_bitmap_data_get_pixel(this->__handle,x,y);
}
...
bool findColor = __o_findColor.Default(true);
	HX_STACK_PUSH("BitmapData::getColorBoundsRect","flash/display/BitmapData.hx",207);
	HX_STACK_THIS(this);
	HX_STACK_ARG(mask,"mask");
	HX_STACK_ARG(color,"color");
	HX_STACK_ARG(findColor,"findColor");
{
		...
		HX_STACK_LINE(210)
		::flash::display::BitmapData_obj::nme_bitmap_data_get_color_bounds_rect(this->__handle,mask,color,findColor,result);
		HX_STACK_LINE(211)
		return result;
	}
}
...
::flash::geom::Rectangle BitmapData_obj::generateFilterRect( ::flash::geom::Rectangle sourceRect,::flash::filters::BitmapFilter filter){
	HX_STACK_PUSH("BitmapData::generateFilterRect","flash/display/BitmapData.hx",198);
	HX_STACK_THIS(this);
	HX_STACK_ARG(sourceRect,"sourceRect");
	...
	::flash::geom::Rectangle result = ::flash::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(201)
	::flash::display::BitmapData_obj::nme_bitmap_data_generate_filter_rect(sourceRect,filter,result);
	HX_STACK_LINE(202)
	return result;
}
...
{
		HX_STACK_PUSH("BitmapData::floodFill","flash/display/BitmapData.hx",191);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(color,"color");
		HX_STACK_LINE(191)
		::flash::display::BitmapData_obj::nme_bitmap_data_flood_fill(this->__handle,x,y,color);
	}
return null();
}
...
int alpha = __o_alpha.Default(255);
	HX_STACK_PUSH("BitmapData::fillRectEx","flash/display/BitmapData.hx",184);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_ARG(color,"color");
...
{
		HX_STACK_LINE(184)
		::flash::display::BitmapData_obj::nme_bitmap_data_fill(this->__handle,rect,color,alpha);
	}
return null();
}
...
{
		HX_STACK_PUSH("BitmapData::fillRect","flash/display/BitmapData.hx",177);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
		HX_STACK_ARG(color,"color");
		HX_STACK_LINE(177)
		::flash::display::BitmapData_obj::nme_bitmap_data_fill(this->__handle,rect,(int(color) & int((int)16777215)),hx::UShr(color,(int)24));
	}
return null();
}
...
Float quality = __o_quality.Default(0.9);
	HX_STACK_PUSH("BitmapData::encode","flash/display/BitmapData.hx",156);
	HX_STACK_THIS(this);
	HX_STACK_ARG(format,"format");
	HX_STACK_ARG(quality,"quality");
{
		HX_STACK_LINE(156)
		return ::flash::display::BitmapData_obj::nme_bitmap_data_encode(this->__handle,format,quality);
	}
}
...
{
		HX_STACK_PUSH("BitmapData::dumpBits","flash/display/BitmapData.hx",149);
		HX_STACK_THIS(this);
		HX_STACK_LINE(149)
		::flash::display::BitmapData_obj::nme_bitmap_data_dump_bits(this->__handle);
	}
return null();
}
...
bool smoothing = __o_smoothing.Default(false);
	HX_STACK_PUSH("BitmapData::draw","flash/display/BitmapData.hx",142);
	HX_STACK_THIS(this);
...
Void BitmapData_obj::destroyHardwareSurface( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(127)
		::flash::display::BitmapData_obj::nme_bitmap_data_destroy_hardware_surface(this->__handle);
	}
return null();
}
...
Void BitmapData_obj::createHardwareSurface( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(120)
		::flash::display::BitmapData_obj::nme_bitmap_data_create_hardware_surface(this->__handle);
	}
return null();
}
...
{
		HX_STACK_LINE(105)
		::flash::display::BitmapData_obj::nme_bitmap_data_copy(sourceBitmapData->__handle,sourceRect,this->__handle,destPoint,mergeAlpha);
	}
return null();
}
...
Void BitmapData_obj::copyChannel( ::flash::display::BitmapData sourceBitmapData,::flash::geom::Rectangle sourceRect,::flash::geom::Point destPoint,int sourceChannel,int destChannel){
{
		...
		HX_STACK_LINE(98)
		::flash::display::BitmapData_obj::nme_bitmap_data_copy_channel(sourceBitmapData->__handle,sourceRect,this->__handle,destPoint,sourceChannel,destChannel);
	}
return null();
}
...
Void BitmapData_obj::colorTransform( ::flash::geom::Rectangle rect,::flash::geom::ColorTransform colorTransform){
{
		...
		HX_STACK_ARG(colorTransform,"colorTransform");
		HX_STACK_LINE(91)
		::flash::display::BitmapData_obj::nme_bitmap_data_color_transform(this->__handle,rect,colorTransform);
	}
return null();
}
...
::flash::display::BitmapData BitmapData_obj::clone( ){
	...
	HX_STACK_LINE(85)
	bitmapData->__handle = ::flash::display::BitmapData_obj::nme_bitmap_data_clone(this->__handle);
	HX_STACK_LINE(86)
	return bitmapData;
}
...
Void BitmapData_obj::clear( int color){
{
		...
		HX_STACK_ARG(color,"color");
		HX_STACK_LINE(75)
		::flash::display::BitmapData_obj::nme_bitmap_data_clear(this->__handle,color);
	}
return null();
}
...
Void BitmapData_obj::applyFilter( ::flash::display::BitmapData sourceBitmapData,::flash::geom::Rectangle sourceRect,::flash::geom::Point destPoint,::flash::filters::BitmapFilter filter){
{
		...
		HX_STACK_ARG(filter,"filter");
		HX_STACK_LINE(68)
		::flash::display::BitmapData_obj::nme_bitmap_data_apply_filter(this->__handle,sourceBitmapData->__handle,sourceRect,destPoint,filter);
	}
return null();
}
...
int BitmapData_obj::extractAlpha( int argb){
	HX_STACK_PUSH("BitmapData::extractAlpha","flash/display/BitmapData.hx",163);
...
int BitmapData_obj::extractColor( int argb){
	HX_STACK_PUSH("BitmapData::extractColor","flash/display/BitmapData.hx",170);
	HX_STACK_ARG(argb,"argb");
	HX_STACK_LINE(170)
...
::flash::utils::ByteArray BitmapData_obj::getRGBAPixels( ::flash::display::BitmapData bitmapData){
	HX_STACK_PUSH("BitmapData::getRGBAPixels","flash/display/BitmapData.hx",239);
...
int format = __o_format.Default(0);
	HX_STACK_PUSH("BitmapData::load","flash/display/BitmapData.hx",286);
	...
	HX_STACK_ARG(format,"format");
{
		...
		HX_STACK_LINE(289)
		result->__handle = ::flash::display::BitmapData_obj::nme_bitmap_data_load(filename,format);
		HX_STACK_LINE(290)
		return result;
	}
}
...
::flash::display::BitmapData BitmapData_obj::loadFromBytes( ::flash::utils::ByteArray bytes,::flash::utils::ByteArray rawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromBytes","flash/display/BitmapData.hx",295);
	HX_STACK_ARG(bytes,"bytes");
	HX_STACK_ARG(rawAlpha,"rawAlpha");
	HX_STACK_LINE(297)
	::flash::display::BitmapData result = ::flash::display::BitmapData_obj::__new((int)0,(int)0,null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(298)
	result->__handle = ::flash::display::BitmapData_obj::nme_bitmap_data_from_bytes(bytes,rawAlpha);
	HX_STACK_LINE(299)
	return result;
}
...
::flash::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes bytes,::haxe::io::Bytes rawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromHaxeBytes","flash/display/BitmapData.hx",304);
	HX_STACK_ARG(bytes,"bytes");
	HX_STACK_ARG(rawAlpha,"rawAlpha");
	HX_STACK_LINE(304)
...
bool BitmapData_obj::sameValue( int a,int b){
	HX_STACK_PUSH("BitmapData::sameValue","flash/display/BitmapData.hx",333);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(333)
	return (a == b);
...
int BitmapData_obj::__flipPixel( int pixel){
	HX_STACK_PUSH("BitmapData::__flipPixel","flash/display/BitmapData.hx",573);
...
int BitmapData_obj::__ucompare( int n1,int n2){
	HX_STACK_PUSH("BitmapData::__ucompare","flash/display/BitmapData.hx",587);
	HX_STACK_ARG(n1,"n1");
	HX_STACK_ARG(n2,"n2");
	HX_STACK_LINE(589)
...
{
	nme_bitmap_data_create= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_create"),(int)-1);
	nme_bitmap_data_load= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_load"),(int)2);
	nme_bitmap_data_from_bytes= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_from_bytes"),(int)2);
	nme_bitmap_data_clear= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_clear"),(int)2);
	nme_bitmap_data_clone= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_clone"),(int)1);
	nme_bitmap_data_apply_filter= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_apply_filter"),(int)5);
	nme_bitmap_data_color_transform= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_color_transform"),(int)3);
	nme_bitmap_data_copy= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_copy"),(int)5);
	nme_bitmap_data_copy_channel= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_copy_channel"),(int)-1);
	nme_bitmap_data_fill= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_fill"),(int)4);
	nme_bitmap_data_get_pixels= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_pixels"),(int)2);
	nme_bitmap_data_get_pixel= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_pixel"),(int)3);
	nme_bitmap_data_get_pixel32= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_pixel32"),(int)3);
	nme_bitmap_data_get_pixel_rgba= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_pixel_rgba"),(int)3);
	nme_bitmap_data_get_array= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_array"),(int)3);
	nme_bitmap_data_get_color_bounds_rect= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_color_bounds_rect"),(int)5);
	nme_bitmap_data_scroll= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_scroll"),(int)3);
	nme_bitmap_data_set_pixel= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_pixel"),(int)4);
	nme_bitmap_data_set_pixel32= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_pixel32"),(int)4);
	nme_bitmap_data_set_pixel_rgba= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_pixel_rgba"),(int)4);
	nme_bitmap_data_set_bytes= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_bytes"),(int)4);
	nme_bitmap_data_set_format= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_format"),(int)2);
	nme_bitmap_data_set_array= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_array"),(int)3);
	nme_bitmap_data_create_hardware_surface= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_create_hardware_surface"),(int)1);
	nme_bitmap_data_destroy_hardware_surface= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_destroy_hardware_surface"),(int)1);
	nme_bitmap_data_generate_filter_rect= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_generate_filter_rect"),(int)3);
	nme_render_surface_to_surface= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_render_surface_to_surface"),(int)-1);
	nme_bitmap_data_height= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_height"),(int)1);
	nme_bitmap_data_width= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_width"),(int)1);
	nme_bitmap_data_get_transparent= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_get_transparent"),(int)1);
	nme_bitmap_data_set_flags= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_set_flags"),(int)1);
	nme_bitmap_data_encode= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_encode"),(int)3);
	nme_bitmap_data_dump_bits= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_dump_bits"),(int)1);
	nme_bitmap_data_noise= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_noise"),(int)-1);
	nme_bitmap_data_flood_fill= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_bitmap_data_flood_fill"),(int)4);
}
