...
{
HX_STACK_PUSH("LoaderInfo::new","flash/display/LoaderInfo.hx",33);
{
	HX_STACK_LINE(35)
...
::flash::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_PUSH("LoaderInfo::get_bytes","flash/display/LoaderInfo.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(107)
	return this->data;
}
...
{
		HX_STACK_PUSH("LoaderInfo::this_onComplete","flash/display/LoaderInfo.hx",93);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("LoaderInfo::load","flash/display/LoaderInfo.hx",62);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static ::String Block( ::String &extension,::flash::display::LoaderInfo_obj *__this){
				HX_STACK_PUSH("*::closure","flash/display/LoaderInfo.hx",68);
				{
					HX_STACK_LINE(68)
...
::flash::display::LoaderInfo LoaderInfo_obj::create( ::flash::display::Loader loader){
	HX_STACK_PUSH("LoaderInfo::create","flash/display/LoaderInfo.hx",46);
