...
HX_STACK_PUSH("DisplayObject::new","flash/display/DisplayObject.hx",55);
{
	...
	HX_STACK_LINE(61)
	this->__id = ::flash::display::DisplayObject_obj::nme_display_object_get_id(this->__handle);
	HX_STACK_LINE(62)
...
Float DisplayObject_obj::set_y( Float value){
	HX_STACK_PUSH("DisplayObject::set_y","flash/display/DisplayObject.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(734)
	::flash::display::DisplayObject_obj::nme_display_object_set_y(this->__handle,value);
	HX_STACK_LINE(735)
	return value;
}
...
Float DisplayObject_obj::get_y( ){
	HX_STACK_PUSH("DisplayObject::get_y","flash/display/DisplayObject.hx",731);
	HX_STACK_THIS(this);
	HX_STACK_LINE(731)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_y(this->__handle);
}
...
Float DisplayObject_obj::set_x( Float value){
	HX_STACK_PUSH("DisplayObject::set_x","flash/display/DisplayObject.hx",723);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(725)
	::flash::display::DisplayObject_obj::nme_display_object_set_x(this->__handle,value);
	HX_STACK_LINE(726)
	return value;
}
...
Float DisplayObject_obj::get_x( ){
	HX_STACK_PUSH("DisplayObject::get_x","flash/display/DisplayObject.hx",722);
	HX_STACK_THIS(this);
	HX_STACK_LINE(722)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_x(this->__handle);
}
...
Float DisplayObject_obj::set_width( Float value){
	HX_STACK_PUSH("DisplayObject::set_width","flash/display/DisplayObject.hx",714);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(716)
	::flash::display::DisplayObject_obj::nme_display_object_set_width(this->__handle,value);
	HX_STACK_LINE(717)
	return value;
}
...
Float DisplayObject_obj::get_width( ){
	HX_STACK_PUSH("DisplayObject::get_width","flash/display/DisplayObject.hx",713);
	HX_STACK_THIS(this);
	HX_STACK_LINE(713)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_width(this->__handle);
}
...
bool DisplayObject_obj::set_visible( bool value){
	HX_STACK_PUSH("DisplayObject::set_visible","flash/display/DisplayObject.hx",705);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(707)
	::flash::display::DisplayObject_obj::nme_display_object_set_visible(this->__handle,value);
	HX_STACK_LINE(708)
	return value;
}
...
bool DisplayObject_obj::get_visible( ){
	HX_STACK_PUSH("DisplayObject::get_visible","flash/display/DisplayObject.hx",704);
	HX_STACK_THIS(this);
	HX_STACK_LINE(704)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_visible(this->__handle);
}
...
::flash::geom::Transform DisplayObject_obj::set_transform( ::flash::geom::Transform value){
	HX_STACK_PUSH("DisplayObject::set_transform","flash/display/DisplayObject.hx",695);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(697)
...
::flash::geom::Transform DisplayObject_obj::get_transform( ){
	HX_STACK_PUSH("DisplayObject::get_transform","flash/display/DisplayObject.hx",694);
	HX_STACK_THIS(this);
	HX_STACK_LINE(694)
...
::flash::display::Stage DisplayObject_obj::get_stage( ){
	HX_STACK_PUSH("DisplayObject::get_stage","flash/display/DisplayObject.hx",681);
	HX_STACK_THIS(this);
	HX_STACK_LINE(683)
...
::flash::geom::Rectangle DisplayObject_obj::set_scrollRect( ::flash::geom::Rectangle value){
	HX_STACK_PUSH("DisplayObject::set_scrollRect","flash/display/DisplayObject.hx",672);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(674)
	this->__scrollRect = (  (((value == null()))) ? ::flash::geom::Rectangle(null()) : ::flash::geom::Rectangle(value->clone()) );
	HX_STACK_LINE(675)
	::flash::display::DisplayObject_obj::nme_display_object_set_scroll_rect(this->__handle,this->__scrollRect);
	HX_STACK_LINE(676)
	return value;
}
...
::flash::geom::Rectangle DisplayObject_obj::get_scrollRect( ){
	HX_STACK_PUSH("DisplayObject::get_scrollRect","flash/display/DisplayObject.hx",671);
	HX_STACK_THIS(this);
	HX_STACK_LINE(671)
...
Float DisplayObject_obj::set_scaleY( Float value){
	HX_STACK_PUSH("DisplayObject::set_scaleY","flash/display/DisplayObject.hx",663);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(665)
	::flash::display::DisplayObject_obj::nme_display_object_set_scale_y(this->__handle,value);
	HX_STACK_LINE(666)
	return value;
}
...
Float DisplayObject_obj::get_scaleY( ){
	HX_STACK_PUSH("DisplayObject::get_scaleY","flash/display/DisplayObject.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_LINE(662)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_scale_y(this->__handle);
}
...
Float DisplayObject_obj::set_scaleX( Float value){
	HX_STACK_PUSH("DisplayObject::set_scaleX","flash/display/DisplayObject.hx",654);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(656)
	::flash::display::DisplayObject_obj::nme_display_object_set_scale_x(this->__handle,value);
	HX_STACK_LINE(657)
	return value;
}
...
Float DisplayObject_obj::get_scaleX( ){
	HX_STACK_PUSH("DisplayObject::get_scaleX","flash/display/DisplayObject.hx",653);
	HX_STACK_THIS(this);
	HX_STACK_LINE(653)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_scale_x(this->__handle);
}
...
::flash::geom::Rectangle DisplayObject_obj::set_scale9Grid( ::flash::geom::Rectangle value){
	HX_STACK_PUSH("DisplayObject::set_scale9Grid","flash/display/DisplayObject.hx",644);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(646)
	this->__scale9Grid = (  (((value == null()))) ? ::flash::geom::Rectangle(null()) : ::flash::geom::Rectangle(value->clone()) );
	HX_STACK_LINE(647)
	::flash::display::DisplayObject_obj::nme_display_object_set_scale9_grid(this->__handle,this->__scale9Grid);
	HX_STACK_LINE(648)
	return value;
}
...
::flash::geom::Rectangle DisplayObject_obj::get_scale9Grid( ){
	HX_STACK_PUSH("DisplayObject::get_scale9Grid","flash/display/DisplayObject.hx",643);
	HX_STACK_THIS(this);
	HX_STACK_LINE(643)
...
Float DisplayObject_obj::set_rotation( Float value){
	HX_STACK_PUSH("DisplayObject::set_rotation","flash/display/DisplayObject.hx",635);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(637)
	::flash::display::DisplayObject_obj::nme_display_object_set_rotation(this->__handle,value);
	HX_STACK_LINE(638)
	return value;
}
...
Float DisplayObject_obj::get_rotation( ){
	HX_STACK_PUSH("DisplayObject::get_rotation","flash/display/DisplayObject.hx",634);
	HX_STACK_THIS(this);
	HX_STACK_LINE(634)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_rotation(this->__handle);
}
...
::flash::display::DisplayObjectContainer DisplayObject_obj::get_parent( ){
	HX_STACK_PUSH("DisplayObject::get_parent","flash/display/DisplayObject.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
::String DisplayObject_obj::set_name( ::String value){
	HX_STACK_PUSH("DisplayObject::set_name","flash/display/DisplayObject.hx",623);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(625)
	::flash::display::DisplayObject_obj::nme_display_object_set_name(this->__handle,value);
	HX_STACK_LINE(626)
	return value;
}
...
::String DisplayObject_obj::get_name( ){
	HX_STACK_PUSH("DisplayObject::get_name","flash/display/DisplayObject.hx",622);
	HX_STACK_THIS(this);
	HX_STACK_LINE(622)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_name(this->__handle);
}
...
Float DisplayObject_obj::get_mouseY( ){
	HX_STACK_PUSH("DisplayObject::get_mouseY","flash/display/DisplayObject.hx",619);
	HX_STACK_THIS(this);
	HX_STACK_LINE(619)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_mouse_y(this->__handle);
}
...
Float DisplayObject_obj::get_mouseX( ){
	HX_STACK_PUSH("DisplayObject::get_mouseX","flash/display/DisplayObject.hx",618);
	HX_STACK_THIS(this);
	HX_STACK_LINE(618)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_mouse_x(this->__handle);
}
...
::flash::display::DisplayObject DisplayObject_obj::set_mask( ::flash::display::DisplayObject value){
	HX_STACK_PUSH("DisplayObject::set_mask","flash/display/DisplayObject.hx",609);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(611)
	this->mask = value;
	HX_STACK_LINE(612)
	::flash::display::DisplayObject_obj::nme_display_object_set_mask(this->__handle,(  (((value == null()))) ? Dynamic(null()) : Dynamic(value->__handle) ));
	HX_STACK_LINE(613)
	return value;
}
...
Float DisplayObject_obj::set_height( Float value){
	HX_STACK_PUSH("DisplayObject::set_height","flash/display/DisplayObject.hx",601);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(603)
	::flash::display::DisplayObject_obj::nme_display_object_set_height(this->__handle,value);
	HX_STACK_LINE(604)
	return value;
}
...
Float DisplayObject_obj::get_height( ){
	HX_STACK_PUSH("DisplayObject::get_height","flash/display/DisplayObject.hx",600);
	HX_STACK_THIS(this);
	HX_STACK_LINE(600)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_height(this->__handle);
}
...
::flash::display::Graphics DisplayObject_obj::get_graphics( ){
	HX_STACK_PUSH("DisplayObject::get_graphics","flash/display/DisplayObject.hx",587);
	HX_STACK_THIS(this);
	HX_STACK_LINE(589)
	if (((this->__graphicsCache == null()))){
		HX_STACK_LINE(589)
		this->__graphicsCache = ::flash::display::Graphics_obj::__new(::flash::display::DisplayObject_obj::nme_display_object_get_graphics(this->__handle));
	}
	HX_STACK_LINE(595)
...
Dynamic DisplayObject_obj::set_filters( Dynamic value){
	HX_STACK_PUSH("DisplayObject::set_filters","flash/display/DisplayObject.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(565)
	if (((this->get_filters() == null()))){
		...
		HX_STACK_LINE(573)
		{
			...
			Dynamic _g1 = this->get_filters();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(573)
	...
	HX_STACK_LINE(581)
	::flash::display::DisplayObject_obj::nme_display_object_set_filters(this->__handle,this->__filters);
	HX_STACK_LINE(582)
...
Dynamic DisplayObject_obj::get_filters( ){
	HX_STACK_PUSH("DisplayObject::get_filters","flash/display/DisplayObject.hx",547);
	HX_STACK_THIS(this);
	HX_STACK_LINE(549)
...
::flash::display::PixelSnapping DisplayObject_obj::set_pixelSnapping( ::flash::display::PixelSnapping value){
	HX_STACK_PUSH("DisplayObject::set_pixelSnapping","flash/display/DisplayObject.hx",530);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(532)
	if (((value == null()))){
		HX_STACK_LINE(532)
		::flash::display::DisplayObject_obj::nme_display_object_set_pixel_snapping(this->__handle,(int)0);
	}
	else{
		HX_STACK_LINE(536)
		::flash::display::DisplayObject_obj::nme_display_object_set_pixel_snapping(this->__handle,value->__Index());
	}
	HX_STACK_LINE(542)
	return value;
}
...
::flash::display::PixelSnapping DisplayObject_obj::get_pixelSnapping( ){
	HX_STACK_PUSH("DisplayObject::get_pixelSnapping","flash/display/DisplayObject.hx",522);
	HX_STACK_THIS(this);
	HX_STACK_LINE(524)
	int i = ::flash::display::DisplayObject_obj::nme_display_object_get_pixel_snapping(this->__handle);		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(525)
...
bool DisplayObject_obj::set_pedanticBitmapCaching( bool value){
	HX_STACK_PUSH("DisplayObject::set_pedanticBitmapCaching","flash/display/DisplayObject.hx",514);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(516)
	::flash::display::DisplayObject_obj::nme_display_object_set_pedantic_bitmap_caching(this->__handle,value);
	HX_STACK_LINE(517)
	return value;
}
...
bool DisplayObject_obj::get_pedanticBitmapCaching( ){
	HX_STACK_PUSH("DisplayObject::get_pedanticBitmapCaching","flash/display/DisplayObject.hx",513);
	HX_STACK_THIS(this);
	HX_STACK_LINE(513)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_pedantic_bitmap_caching(this->__handle);
}
...
bool DisplayObject_obj::set_cacheAsBitmap( bool value){
	HX_STACK_PUSH("DisplayObject::set_cacheAsBitmap","flash/display/DisplayObject.hx",505);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(507)
	::flash::display::DisplayObject_obj::nme_display_object_set_cache_as_bitmap(this->__handle,value);
	HX_STACK_LINE(508)
	return value;
}
...
bool DisplayObject_obj::get_cacheAsBitmap( ){
	HX_STACK_PUSH("DisplayObject::get_cacheAsBitmap","flash/display/DisplayObject.hx",504);
	HX_STACK_THIS(this);
	HX_STACK_LINE(504)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_cache_as_bitmap(this->__handle);
}
...
::flash::display::BlendMode DisplayObject_obj::set_blendMode( ::flash::display::BlendMode value){
	HX_STACK_PUSH("DisplayObject::set_blendMode","flash/display/DisplayObject.hx",496);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(498)
	::flash::display::DisplayObject_obj::nme_display_object_set_blend_mode(this->__handle,value->__Index());
	HX_STACK_LINE(499)
	return value;
}
...
::flash::display::BlendMode DisplayObject_obj::get_blendMode( ){
	HX_STACK_PUSH("DisplayObject::get_blendMode","flash/display/DisplayObject.hx",488);
	HX_STACK_THIS(this);
	HX_STACK_LINE(490)
	int i = ::flash::display::DisplayObject_obj::nme_display_object_get_blend_mode(this->__handle);		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(491)
...
Dynamic DisplayObject_obj::set_opaqueBackground( Dynamic value){
	HX_STACK_PUSH("DisplayObject::set_opaqueBackground","flash/display/DisplayObject.hx",471);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(473)
	if (((value == null()))){
		HX_STACK_LINE(473)
		::flash::display::DisplayObject_obj::nme_display_object_set_bg(this->__handle,(int)0);
	}
	else{
		HX_STACK_LINE(477)
		::flash::display::DisplayObject_obj::nme_display_object_set_bg(this->__handle,value);
	}
	HX_STACK_LINE(483)
	return value;
}
...
Dynamic DisplayObject_obj::get_opaqueBackground( ){
	HX_STACK_PUSH("DisplayObject::get_opaqueBackground","flash/display/DisplayObject.hx",456);
	HX_STACK_THIS(this);
	HX_STACK_LINE(458)
	int i = ::flash::display::DisplayObject_obj::nme_display_object_get_bg(this->__handle);		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(460)
...
Float DisplayObject_obj::set_alpha( Float value){
	HX_STACK_PUSH("DisplayObject::set_alpha","flash/display/DisplayObject.hx",448);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(450)
	::flash::display::DisplayObject_obj::nme_display_object_set_alpha(this->__handle,value);
	HX_STACK_LINE(451)
	return value;
}
...
Float DisplayObject_obj::get_alpha( ){
	HX_STACK_PUSH("DisplayObject::get_alpha","flash/display/DisplayObject.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_LINE(447)
	return ::flash::display::DisplayObject_obj::nme_display_object_get_alpha(this->__handle);
}
...
::flash::display::DisplayObjectContainer DisplayObject_obj::__setParent( ::flash::display::DisplayObjectContainer parent){
	HX_STACK_PUSH("DisplayObject::__setParent","flash/display/DisplayObject.hx",404);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObject::__setMatrix","flash/display/DisplayObject.hx",397);
		HX_STACK_THIS(this);
		HX_STACK_ARG(matrix,"matrix");
		HX_STACK_LINE(397)
		::flash::display::DisplayObject_obj::nme_display_object_set_matrix(this->__handle,matrix);
	}
return null();
}
...
{
		HX_STACK_PUSH("DisplayObject::__setColorTransform","flash/display/DisplayObject.hx",390);
		HX_STACK_THIS(this);
		HX_STACK_ARG(colorTransform,"colorTransform");
		HX_STACK_LINE(390)
		::flash::display::DisplayObject_obj::nme_display_object_set_color_transform(this->__handle,colorTransform);
	}
return null();
}
...
{
		HX_STACK_PUSH("DisplayObject::__onRemoved","flash/display/DisplayObject.hx",369);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("DisplayObject::__onAdded","flash/display/DisplayObject.hx",348);
		HX_STACK_THIS(this);
		HX_STACK_ARG(object,"object");
...
::flash::geom::Rectangle DisplayObject_obj::__getPixelBounds( ){
	HX_STACK_PUSH("DisplayObject::__getPixelBounds","flash/display/DisplayObject.hx",339);
	HX_STACK_THIS(this);
	HX_STACK_LINE(341)
	::flash::geom::Rectangle bounds = ::flash::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(bounds,"bounds");
	HX_STACK_LINE(342)
	::flash::display::DisplayObject_obj::nme_display_object_get_pixel_bounds(this->__handle,bounds);
	HX_STACK_LINE(343)
	return bounds;
}
...
{
		HX_STACK_PUSH("DisplayObject::__getObjectsUnderPoint","flash/display/DisplayObject.hx",328);
		HX_STACK_THIS(this);
		HX_STACK_ARG(point,"point");
		HX_STACK_ARG(result,"result");
		HX_STACK_LINE(328)
		if ((::flash::display::DisplayObject_obj::nme_display_object_hit_test_point(this->__handle,point->x,point->y,true,false))){
			HX_STACK_LINE(330)
...
::flash::geom::Matrix DisplayObject_obj::__getMatrix( ){
	HX_STACK_PUSH("DisplayObject::__getMatrix","flash/display/DisplayObject.hx",319);
	HX_STACK_THIS(this);
	HX_STACK_LINE(321)
	::flash::geom::Matrix matrix = ::flash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(matrix,"matrix");
	HX_STACK_LINE(322)
	::flash::display::DisplayObject_obj::nme_display_object_get_matrix(this->__handle,matrix,false);
	HX_STACK_LINE(323)
	return matrix;
}
...
{
		HX_STACK_PUSH("DisplayObject::__getInteractiveObjectStack","flash/display/DisplayObject.hx",300);
		HX_STACK_THIS(this);
...
::flash::geom::Matrix DisplayObject_obj::__getConcatenatedMatrix( ){
	HX_STACK_PUSH("DisplayObject::__getConcatenatedMatrix","flash/display/DisplayObject.hx",291);
	HX_STACK_THIS(this);
	HX_STACK_LINE(293)
	::flash::geom::Matrix matrix = ::flash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(matrix,"matrix");
	HX_STACK_LINE(294)
	::flash::display::DisplayObject_obj::nme_display_object_get_matrix(this->__handle,matrix,true);
	HX_STACK_LINE(295)
	return matrix;
}
...
::flash::geom::ColorTransform DisplayObject_obj::__getConcatenatedColorTransform( ){
	HX_STACK_PUSH("DisplayObject::__getConcatenatedColorTransform","flash/display/DisplayObject.hx",282);
	HX_STACK_THIS(this);
	HX_STACK_LINE(284)
	...
	HX_STACK_LINE(285)
	::flash::display::DisplayObject_obj::nme_display_object_get_color_transform(this->__handle,colorTransform,true);
	HX_STACK_LINE(286)
...
::flash::geom::ColorTransform DisplayObject_obj::__getColorTransform( ){
	HX_STACK_PUSH("DisplayObject::__getColorTransform","flash/display/DisplayObject.hx",273);
	HX_STACK_THIS(this);
	HX_STACK_LINE(275)
	::flash::geom::ColorTransform colorTransform = ::flash::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(colorTransform,"colorTransform");
	HX_STACK_LINE(276)
	::flash::display::DisplayObject_obj::nme_display_object_get_color_transform(this->__handle,colorTransform,false);
	HX_STACK_LINE(277)
	return colorTransform;
}
...
{
		HX_STACK_PUSH("DisplayObject::__fireEvent","flash/display/DisplayObject.hx",210);
		HX_STACK_THIS(this);
...
::flash::display::DisplayObject DisplayObject_obj::__findByID( int id){
	HX_STACK_PUSH("DisplayObject::__findByID","flash/display/DisplayObject.hx",197);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(199)
	if (((this->__id == id))){
...
{
		HX_STACK_PUSH("DisplayObject::__drawToSurface","flash/display/DisplayObject.hx",190);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(190)
		::flash::display::DisplayObject_obj::nme_display_object_draw_to_surface(this->__handle,surface,matrix,colorTransform,blendMode,clipRect);
	}
return null();
}
...
bool DisplayObject_obj::__dispatchEvent( ::flash::events::Event event){
	HX_STACK_PUSH("DisplayObject::__dispatchEvent","flash/display/DisplayObject.hx",176);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(178)
...
::flash::geom::Point DisplayObject_obj::localToGlobal( ::flash::geom::Point point){
	...
	HX_STACK_LINE(149)
	::flash::display::DisplayObject_obj::nme_display_object_local_to_global(this->__handle,result);
	HX_STACK_LINE(150)
	return result;
}
...
{
		HX_STACK_LINE(139)
		return ::flash::display::DisplayObject_obj::nme_display_object_hit_test_point(this->__handle,x,y,shapeFlag,true);
	}
}
...
::flash::geom::Point DisplayObject_obj::globalToLocal( ::flash::geom::Point point){
	...
	::flash::geom::Point result = point->clone();		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(106)
	::flash::display::DisplayObject_obj::nme_display_object_global_to_local(this->__handle,result);
	HX_STACK_LINE(107)
	return result;
}
...
::flash::geom::Rectangle DisplayObject_obj::getRect( ::flash::display::DisplayObject targetCoordinateSpace){
	...
	HX_STACK_LINE(97)
	::flash::display::DisplayObject_obj::nme_display_object_get_bounds(this->__handle,targetCoordinateSpace->__handle,result,false);
	HX_STACK_LINE(98)
	return result;
}
...
::flash::geom::Rectangle DisplayObject_obj::getBounds( ::flash::display::DisplayObject targetCoordinateSpace){
	...
	::flash::geom::Rectangle result = ::flash::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(88)
	::flash::display::DisplayObject_obj::nme_display_object_get_bounds(this->__handle,targetCoordinateSpace->__handle,result,true);
	HX_STACK_LINE(89)
	return result;
}
...
{
	nme_create_display_object= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_create_display_object"),(int)0);
	nme_display_object_get_graphics= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_graphics"),(int)1);
	nme_display_object_draw_to_surface= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_draw_to_surface"),(int)-1);
	nme_display_object_get_id= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_id"),(int)1);
	nme_display_object_get_x= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_x"),(int)1);
	nme_display_object_set_x= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_x"),(int)2);
	nme_display_object_get_y= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_y"),(int)1);
	nme_display_object_set_y= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_y"),(int)2);
	nme_display_object_get_scale_x= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_scale_x"),(int)1);
	nme_display_object_set_scale_x= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_scale_x"),(int)2);
	nme_display_object_get_scale_y= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_scale_y"),(int)1);
	nme_display_object_set_scale_y= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_scale_y"),(int)2);
	nme_display_object_get_mouse_x= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_mouse_x"),(int)1);
	nme_display_object_get_mouse_y= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_mouse_y"),(int)1);
	nme_display_object_get_rotation= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_rotation"),(int)1);
	nme_display_object_set_rotation= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_rotation"),(int)2);
	nme_display_object_get_bg= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_bg"),(int)1);
	nme_display_object_set_bg= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_bg"),(int)2);
	nme_display_object_get_name= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_name"),(int)1);
	nme_display_object_set_name= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_name"),(int)2);
	nme_display_object_get_width= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_width"),(int)1);
	nme_display_object_set_width= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_width"),(int)2);
	nme_display_object_get_height= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_height"),(int)1);
	nme_display_object_set_height= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_height"),(int)2);
	nme_display_object_get_alpha= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_alpha"),(int)1);
	nme_display_object_set_alpha= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_alpha"),(int)2);
	nme_display_object_get_blend_mode= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_blend_mode"),(int)1);
	nme_display_object_set_blend_mode= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_blend_mode"),(int)2);
	nme_display_object_get_cache_as_bitmap= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_cache_as_bitmap"),(int)1);
	nme_display_object_set_cache_as_bitmap= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_cache_as_bitmap"),(int)2);
	nme_display_object_get_pedantic_bitmap_caching= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_pedantic_bitmap_caching"),(int)1);
	nme_display_object_set_pedantic_bitmap_caching= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_pedantic_bitmap_caching"),(int)2);
	nme_display_object_get_pixel_snapping= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_pixel_snapping"),(int)1);
	nme_display_object_set_pixel_snapping= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_pixel_snapping"),(int)2);
	nme_display_object_get_visible= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_visible"),(int)1);
	nme_display_object_set_visible= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_visible"),(int)2);
	nme_display_object_set_filters= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_filters"),(int)2);
	nme_display_object_global_to_local= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_global_to_local"),(int)2);
	nme_display_object_local_to_global= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_local_to_global"),(int)2);
	nme_display_object_set_scale9_grid= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_scale9_grid"),(int)2);
	nme_display_object_set_scroll_rect= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_scroll_rect"),(int)2);
	nme_display_object_set_mask= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_mask"),(int)2);
	nme_display_object_set_matrix= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_matrix"),(int)2);
	nme_display_object_get_matrix= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_matrix"),(int)3);
	nme_display_object_get_color_transform= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_color_transform"),(int)3);
	nme_display_object_set_color_transform= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_set_color_transform"),(int)2);
	nme_display_object_get_pixel_bounds= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_pixel_bounds"),(int)2);
	nme_display_object_get_bounds= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_get_bounds"),(int)4);
	nme_display_object_hit_test_point= ::flash::Lib_obj::load(HX_CSTRING("nme"),HX_CSTRING("nme_display_object_hit_test_point"),(int)5);
}
