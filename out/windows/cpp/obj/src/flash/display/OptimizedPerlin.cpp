...
{
HX_STACK_PUSH("OptimizedPerlin::new","flash/display/BitmapData.hx",777);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","flash/display/BitmapData.hx",923);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","flash/display/BitmapData.hx",900);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","flash/display/BitmapData.hx",786);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",849);
										{
											HX_STACK_LINE(849)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",852);
										{
											HX_STACK_LINE(852)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",855);
										{
											HX_STACK_LINE(855)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",858);
										{
											HX_STACK_LINE(858)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",861);
										{
											HX_STACK_LINE(861)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
