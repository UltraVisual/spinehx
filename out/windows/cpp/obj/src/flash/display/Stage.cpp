...
{
HX_STACK_PUSH("Stage::new","flash/display/Stage.hx",80);
{
	HX_STACK_LINE(82)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_PUSH("Stage::get_stageWidth","flash/display/Stage.hx",1130);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1130)
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_PUSH("Stage::get_stageHeight","flash/display/Stage.hx",1123);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1123)
...
bool Stage_obj::set_stageFocusRect( bool value){
	HX_STACK_PUSH("Stage::set_stageFocusRect","flash/display/Stage.hx",1115);
	HX_STACK_THIS(this);
...
bool Stage_obj::get_stageFocusRect( ){
	HX_STACK_PUSH("Stage::get_stageFocusRect","flash/display/Stage.hx",1114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1114)
...
::flash::display::Stage Stage_obj::get_stage( ){
	HX_STACK_PUSH("Stage::get_stage","flash/display/Stage.hx",1107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1107)
...
::flash::display::StageScaleMode Stage_obj::set_scaleMode( ::flash::display::StageScaleMode value){
	HX_STACK_PUSH("Stage::set_scaleMode","flash/display/Stage.hx",1099);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1101)
...
::flash::display::StageScaleMode Stage_obj::get_scaleMode( ){
	HX_STACK_PUSH("Stage::get_scaleMode","flash/display/Stage.hx",1091);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1093)
...
::flash::display::StageQuality Stage_obj::set_quality( ::flash::display::StageQuality value){
	HX_STACK_PUSH("Stage::set_quality","flash/display/Stage.hx",1083);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1085)
...
::flash::display::StageQuality Stage_obj::get_quality( ){
	HX_STACK_PUSH("Stage::get_quality","flash/display/Stage.hx",1075);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1077)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_PUSH("Stage::get_isOpenGL","flash/display/Stage.hx",1068);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1068)
...
Float Stage_obj::set_frameRate( Float value){
	HX_STACK_PUSH("Stage::set_frameRate","flash/display/Stage.hx",1059);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1061)
...
::flash::display::InteractiveObject Stage_obj::set_focus( ::flash::display::InteractiveObject value){
	HX_STACK_PUSH("Stage::set_focus","flash/display/Stage.hx",1042);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1044)
	if (((value == null()))){
...
::flash::display::InteractiveObject Stage_obj::get_focus( ){
	HX_STACK_PUSH("Stage::get_focus","flash/display/Stage.hx",1033);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1035)
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_PUSH("Stage::get_dpiScale","flash/display/Stage.hx",1026);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1026)
...
::flash::display::StageDisplayState Stage_obj::set_displayState( ::flash::display::StageDisplayState value){
	HX_STACK_PUSH("Stage::set_displayState","flash/display/Stage.hx",1018);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1020)
...
::flash::display::StageDisplayState Stage_obj::get_displayState( ){
	HX_STACK_PUSH("Stage::get_displayState","flash/display/Stage.hx",1010);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1012)
...
::flash::display::StageAlign Stage_obj::set_align( ::flash::display::StageAlign value){
	HX_STACK_PUSH("Stage::set_align","flash/display/Stage.hx",1002);
	HX_STACK_THIS(this);
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(1004)
...
::flash::display::StageAlign Stage_obj::get_align( ){
	HX_STACK_PUSH("Stage::get_align","flash/display/Stage.hx",994);
	HX_STACK_THIS(this);
	HX_STACK_LINE(996)
...
Float Stage_obj::__updateNextWake( ){
	HX_STACK_PUSH("Stage::__updateNextWake","flash/display/Stage.hx",964);
	HX_STACK_THIS(this);
	HX_STACK_LINE(966)
...
{
		HX_STACK_PUSH("Stage::__stopDrag","flash/display/Stage.hx",956);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__startDrag","flash/display/Stage.hx",923);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sprite,"sprite");
...
{
		HX_STACK_PUSH("Stage::__setActive","flash/display/Stage.hx",897);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(897)
...
{
		HX_STACK_PUSH("Stage::__render","flash/display/Stage.hx",871);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__pollTimers","flash/display/Stage.hx",861);
		HX_STACK_THIS(this);
		HX_STACK_LINE(863)
...
{
		HX_STACK_PUSH("Stage::__onTouch","flash/display/Stage.hx",814);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onSysWM","flash/display/Stage.hx",806);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(808)
...
{
		HX_STACK_PUSH("Stage::__onResize","flash/display/Stage.hx",798);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__onMouse","flash/display/Stage.hx",681);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
...
{
		HX_STACK_PUSH("Stage::__onKey","flash/display/Stage.hx",632);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(634)
		...
		if (((stack->length > (int)0))){
			...
			HX_STACK_LINE(661)
			if (((bool((bool((((int(flags) & int(::flash::display::Stage_obj::efAltDown))) > (int)0)) && bool((event->__Field(HX_CSTRING("result"),true) != (int)-1)))) && bool((event->__Field(HX_CSTRING("code"),true) == ::flash::ui::Keyboard_obj::ENTER))))){
				HX_STACK_LINE(661)
...
{
		HX_STACK_PUSH("Stage::__onJoystick","flash/display/Stage.hx",561);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(type,"type");
		HX_STACK_LINE(563)
		...
		if (  ( _switch_1==HX_CSTRING("axisMove"))){
			struct _Function_2_1{
				inline static Array< Float > Block( Dynamic &event,::flash::display::Stage_obj *__this){
					HX_STACK_PUSH("*::closure","flash/display/Stage.hx",569);
					{
						HX_STACK_LINE(569)
...
{
		HX_STACK_PUSH("Stage::__onFocus","flash/display/Stage.hx",529);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(531)
		Array< ::Dynamic > stack = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(stack,"stack");
...
{
		HX_STACK_PUSH("Stage::__onChange","flash/display/Stage.hx",516);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_LINE(518)
		::flash::display::DisplayObject object = this->__findByID(event->__Field(HX_CSTRING("id"),true));		HX_STACK_VAR(object,"object");
...
Float Stage_obj::__nextFrameDue( Float otherTimers){
	HX_STACK_PUSH("Stage::__nextFrameDue","flash/display/Stage.hx",492);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::__drag","flash/display/Stage.hx",450);
		HX_STACK_THIS(this);
...
Dynamic Stage_obj::__processStageEvent( Dynamic event){
	HX_STACK_PUSH("Stage::__processStageEvent","flash/display/Stage.hx",442);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(444)
...
Float Stage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_PUSH("Stage::__doProcessStageEvent","flash/display/Stage.hx",288);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
	HX_STACK_LINE(290)
	...
	switch( (int)(type)){
		...
		case (int)16: {
			struct _Function_2_1{
				inline static ::flash::display::TouchInfo Block( Dynamic &event,::flash::display::Stage_obj *__this){
					HX_STACK_PUSH("*::closure","flash/display/Stage.hx",369);
					{
						HX_STACK_LINE(369)
						int key = event->__Field(HX_CSTRING("value"),true);		HX_STACK_VAR(key,"key");
						HX_STACK_LINE(369)
		...
		case (int)17: {
			struct _Function_2_1{
				inline static ::flash::display::TouchInfo Block( Dynamic &event,::flash::display::Stage_obj *__this){
					HX_STACK_PUSH("*::closure","flash/display/Stage.hx",374);
					{
						HX_STACK_LINE(374)
						int key = event->__Field(HX_CSTRING("value"),true);		HX_STACK_VAR(key,"key");
						HX_STACK_LINE(374)
...
{
		HX_STACK_PUSH("Stage::__checkRender","flash/display/Stage.hx",252);
		HX_STACK_THIS(this);
		HX_STACK_LINE(252)
		if (((this->frameRate > (int)0))){
			HX_STACK_LINE(256)
...
bool Stage_obj::__checkInOuts( ::flash::events::MouseEvent event,Array< ::Dynamic > stack,::flash::display::TouchInfo touchInfo){
	HX_STACK_PUSH("Stage::__checkInOuts","flash/display/Stage.hx",182);
	HX_STACK_THIS(this);
	HX_STACK_ARG(event,"event");
...
{
		HX_STACK_PUSH("Stage::__checkFocusInOuts","flash/display/Stage.hx",150);
		HX_STACK_THIS(this);
		HX_STACK_ARG(event,"event");
		HX_STACK_ARG(stack,"stack");
		HX_STACK_LINE(152)
...
{
		HX_STACK_PUSH("Stage::showCursor","flash/display/Stage.hx",143);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stage::invalidate","flash/display/Stage.hx",121);
		HX_STACK_THIS(this);
		HX_STACK_LINE(121)
		this->__invalid = true;
	}
...
int run(){
	HX_STACK_PUSH("Stage::getOrientation","flash/display/Stage.hx",107);
	HX_STACK_LINE(107)
...
int run(){
	HX_STACK_PUSH("Stage::getNormalOrientation","flash/display/Stage.hx",114);
	HX_STACK_LINE(114)
...
{
		HX_STACK_PUSH("Stage::setFixedOrientation","flash/display/Stage.hx",128);
...
bool run(int orientation){
	HX_STACK_PUSH("Stage::shouldRotateInterface","flash/display/Stage.hx",136);
	HX_STACK_ARG(orientation,"orientation");
	HX_STACK_LINE(136)
