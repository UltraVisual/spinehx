...
Float Point_obj::get_length( ){
	HX_STACK_PUSH("Point::get_length","flash/geom/Point.hx",118);
	HX_STACK_THIS(this);
	HX_STACK_LINE(118)
...
::String Point_obj::toString( ){
	HX_STACK_PUSH("Point::toString","flash/geom/Point.hx",104);
	HX_STACK_THIS(this);
	HX_STACK_LINE(104)
...
::flash::geom::Point Point_obj::subtract( ::flash::geom::Point v){
	HX_STACK_PUSH("Point::subtract","flash/geom/Point.hx",97);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(97)
