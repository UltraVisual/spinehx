...
HX_STACK_PUSH("ByteArray::__init__","flash/utils/ByteArray.hx",689);
{

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	::flash::utils::ByteArray run(int length){
		HX_STACK_PUSH("*::_Function_1_1","flash/utils/ByteArray.hx",691);
	...
	Void run(::flash::utils::ByteArray bytes,int length){
		HX_STACK_PUSH("*::_Function_1_2","flash/utils/ByteArray.hx",692);
	...
	Array< unsigned char > run(::flash::utils::ByteArray bytes){
		HX_STACK_PUSH("*::_Function_1_3","flash/utils/ByteArray.hx",704);
		HX_STACK_ARG(bytes,"bytes");
		{
			HX_STACK_LINE(704)
	...
	int run(::flash::utils::ByteArray bytes1){
		HX_STACK_PUSH("*::_Function_1_4","flash/utils/ByteArray.hx",705);
...
::String ByteArray_obj::set_endian( ::String value){
	HX_STACK_PUSH("ByteArray::set_endian","flash/utils/ByteArray.hx",744);
	HX_STACK_THIS(this);
...
::String ByteArray_obj::get_endian( ){
	HX_STACK_PUSH("ByteArray::get_endian","flash/utils/ByteArray.hx",743);
	HX_STACK_THIS(this);
	HX_STACK_LINE(743)
...
int ByteArray_obj::get_byteLength( ){
	HX_STACK_PUSH("ByteArray::get_byteLength","flash/utils/ByteArray.hx",742);
	HX_STACK_THIS(this);
	HX_STACK_LINE(742)
	return this->length;
}
...
int ByteArray_obj::get_bytesAvailable( ){
	HX_STACK_PUSH("ByteArray::get_bytesAvailable","flash/utils/ByteArray.hx",741);
	HX_STACK_THIS(this);
	HX_STACK_LINE(741)
...
int ByteArray_obj::__throwEOFi( ){
	HX_STACK_PUSH("ByteArray::__throwEOFi","flash/utils/ByteArray.hx",726);
	HX_STACK_THIS(this);
	HX_STACK_LINE(728)
...
{
		HX_STACK_PUSH("ByteArray::__set","flash/utils/ByteArray.hx",715);
		HX_STACK_THIS(this);
...
int ByteArray_obj::__get( int pos){
	HX_STACK_PUSH("ByteArray::__get","flash/utils/ByteArray.hx",676);
	HX_STACK_THIS(this);
	HX_STACK_ARG(pos,"pos");
	HX_STACK_LINE(676)
...
{
		HX_STACK_PUSH("ByteArray::__fromBytes","flash/utils/ByteArray.hx",664);
		HX_STACK_THIS(this);
		HX_STACK_ARG(bytes,"bytes");
		HX_STACK_LINE(666)
		this->b = bytes->b;
...
{
		HX_STACK_PUSH("ByteArray::writeUTFBytes","flash/utils/ByteArray.hx",651);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(656)
...
{
		HX_STACK_PUSH("ByteArray::writeUTF","flash/utils/ByteArray.hx",637);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(642)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);		HX_STACK_VAR(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeUnsignedInt","flash/utils/ByteArray.hx",630);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(630)
		this->writeInt(value);
...
{
		HX_STACK_PUSH("ByteArray::writeShort","flash/utils/ByteArray.hx",611);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(613)
...
{
		HX_STACK_PUSH("ByteArray::writeInt","flash/utils/ByteArray.hx",588);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(590)
...
{
		HX_STACK_PUSH("ByteArray::writeFloat","flash/utils/ByteArray.hx",575);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(580)
...
{
		HX_STACK_PUSH("ByteArray::writeFile","flash/utils/ByteArray.hx",566);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::writeDouble","flash/utils/ByteArray.hx",551);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(556)
...
int length = __o_length.Default(0);
	HX_STACK_PUSH("ByteArray::writeBytes","flash/utils/ByteArray.hx",540);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bytes,"bytes");
...
{
		HX_STACK_PUSH("ByteArray::writeByte","flash/utils/ByteArray.hx",527);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(529)
...
{
		HX_STACK_PUSH("ByteArray::writeBoolean","flash/utils/ByteArray.hx",520);
		HX_STACK_THIS(this);
		HX_STACK_ARG(value,"value");
		HX_STACK_LINE(522)
		this->ensureElem(this->position,true);
...
{
		HX_STACK_PUSH("ByteArray::write_uncheck","flash/utils/ByteArray.hx",509);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::uncompress","flash/utils/ByteArray.hx",465);
		HX_STACK_THIS(this);
		HX_STACK_ARG(algorithm,"algorithm");
		HX_STACK_LINE(467)
		if (((algorithm == null()))){
			HX_STACK_LINE(467)
			algorithm = ::flash::utils::CompressionAlgorithm_obj::GZIP;
		}
		HX_STACK_LINE(472)
		...
		if (((algorithm == ::flash::utils::CompressionAlgorithm_obj::LZMA))){
			...
			struct _Function_2_1{
				inline static int Block( ::flash::utils::CompressionAlgorithm &algorithm){
					HX_STACK_PUSH("*::closure","flash/utils/ByteArray.hx",483);
					{
						HX_STACK_LINE(483)
						{
...
::flash::utils::ByteArray ByteArray_obj::slice( int begin,Dynamic end){
	HX_STACK_PUSH("ByteArray::slice","flash/utils/ByteArray.hx",417);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::setLength","flash/utils/ByteArray.hx",404);
		HX_STACK_THIS(this);
		HX_STACK_ARG(length,"length");
		HX_STACK_LINE(406)
		if (((length > (int)0))){
...
::String ByteArray_obj::readUTFBytes( int length){
	HX_STACK_PUSH("ByteArray::readUTFBytes","flash/utils/ByteArray.hx",382);
	HX_STACK_THIS(this);
	HX_STACK_ARG(length,"length");
	HX_STACK_LINE(384)
...
::String ByteArray_obj::readUTF( ){
	HX_STACK_PUSH("ByteArray::readUTF","flash/utils/ByteArray.hx",374);
	HX_STACK_THIS(this);
	HX_STACK_LINE(376)
...
int ByteArray_obj::readUnsignedShort( ){
	HX_STACK_PUSH("ByteArray::readUnsignedShort","flash/utils/ByteArray.hx",364);
	HX_STACK_THIS(this);
	HX_STACK_LINE(366)
...
int ByteArray_obj::readUnsignedInt( ){
	HX_STACK_PUSH("ByteArray::readUnsignedInt","flash/utils/ByteArray.hx",352);
	HX_STACK_THIS(this);
	HX_STACK_LINE(354)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->__throwEOFi()) );		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(355)
...
int ByteArray_obj::readUnsignedByte( ){
	HX_STACK_PUSH("ByteArray::readUnsignedByte","flash/utils/ByteArray.hx",345);
	HX_STACK_THIS(this);
	HX_STACK_LINE(345)
...
int ByteArray_obj::readShort( ){
	HX_STACK_PUSH("ByteArray::readShort","flash/utils/ByteArray.hx",333);
	HX_STACK_THIS(this);
	HX_STACK_LINE(335)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->__throwEOFi()) );		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(336)
...
::String ByteArray_obj::readMultiByte( int length,::String charSet){
	HX_STACK_PUSH("ByteArray::readMultiByte","flash/utils/ByteArray.hx",326);
	HX_STACK_THIS(this);
	HX_STACK_ARG(length,"length");
...
int ByteArray_obj::readInt( ){
	HX_STACK_PUSH("ByteArray::readInt","flash/utils/ByteArray.hx",314);
	HX_STACK_THIS(this);
	HX_STACK_LINE(316)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->__throwEOFi()) );		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(317)
...
Float ByteArray_obj::readFloat( ){
	HX_STACK_PUSH("ByteArray::readFloat","flash/utils/ByteArray.hx",294);
	HX_STACK_THIS(this);
	HX_STACK_LINE(296)
...
Float ByteArray_obj::readDouble( ){
	HX_STACK_PUSH("ByteArray::readDouble","flash/utils/ByteArray.hx",263);
	HX_STACK_THIS(this);
	HX_STACK_LINE(265)
...
int offset = __o_offset.Default(0);
int length = __o_length.Default(0);
	HX_STACK_PUSH("ByteArray::readBytes","flash/utils/ByteArray.hx",225);
	HX_STACK_THIS(this);
...
int ByteArray_obj::readByte( ){
	HX_STACK_PUSH("ByteArray::readByte","flash/utils/ByteArray.hx",217);
	HX_STACK_THIS(this);
	HX_STACK_LINE(219)
...
bool ByteArray_obj::readBoolean( ){
	HX_STACK_PUSH("ByteArray::readBoolean","flash/utils/ByteArray.hx",210);
	HX_STACK_THIS(this);
	HX_STACK_LINE(210)
...
{
		HX_STACK_PUSH("ByteArray::inflate","flash/utils/ByteArray.hx",203);
		HX_STACK_THIS(this);
		HX_STACK_LINE(203)
...
int ByteArray_obj::getStart( ){
	HX_STACK_PUSH("ByteArray::getStart","flash/utils/ByteArray.hx",196);
	HX_STACK_THIS(this);
	HX_STACK_LINE(196)
	return (int)0;
}
...
int ByteArray_obj::getLength( ){
	HX_STACK_PUSH("ByteArray::getLength","flash/utils/ByteArray.hx",189);
	HX_STACK_THIS(this);
	HX_STACK_LINE(189)
	return this->length;
}
...
::flash::utils::ByteArray ByteArray_obj::getByteBuffer( ){
	HX_STACK_PUSH("ByteArray::getByteBuffer","flash/utils/ByteArray.hx",182);
	HX_STACK_THIS(this);
	HX_STACK_LINE(182)
...
{
		HX_STACK_PUSH("ByteArray::ensureElem","flash/utils/ByteArray.hx",144);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ByteArray::deflate","flash/utils/ByteArray.hx",137);
		HX_STACK_THIS(this);
		HX_STACK_LINE(137)
...
Void ByteArray_obj::compress( ::flash::utils::CompressionAlgorithm algorithm){
{
		...
		if (((algorithm == ::flash::utils::CompressionAlgorithm_obj::LZMA))){
			...
			struct _Function_2_1{
				inline static int Block( ::flash::utils::CompressionAlgorithm &algorithm){
					HX_STACK_PUSH("*::closure","flash/utils/ByteArray.hx",111);
					{
						HX_STACK_LINE(111)
						{
...
::flash::utils::ByteArray ByteArray_obj::fromBytes( ::haxe::io::Bytes bytes){
	HX_STACK_PUSH("ByteArray::fromBytes","flash/utils/ByteArray.hx",173);
	HX_STACK_ARG(bytes,"bytes");
	HX_STACK_LINE(175)
...
::flash::utils::ByteArray ByteArray_obj::readFile( ::String path){
	HX_STACK_PUSH("ByteArray::readFile","flash/utils/ByteArray.hx",285);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(285)
