...
Dynamic StringMap_obj::iterator( ){
	HX_STACK_PUSH("StringMap::iterator","C:\\HaxeToolkit\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_LINE(60)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it,Array< ::Dynamic > &me){
			HX_STACK_PUSH("*::closure","C:\\HaxeToolkit\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",64);
			{
				hx::Anon __result = hx::Anon_obj::Create();

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Dynamic,it)
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","C:\\HaxeToolkit\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",65);
					{
						HX_STACK_LINE(65)
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","C:\\HaxeToolkit\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",66);
					{
						HX_STACK_LINE(66)
