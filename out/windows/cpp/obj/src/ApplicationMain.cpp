...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(34)
		::flash::Lib_obj::setPackage(HX_CSTRING("spinehx"),HX_CSTRING("spinehx-AnimationStateTest"),HX_CSTRING("org.bitbucket.nitrobin.spinehx.AnimationStateTest"),HX_CSTRING("1.0.0"));

		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",68);
			{
				HX_STACK_LINE(71)
				...
				HX_STACK_LINE(101)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::spinehx::AnimationStateTest >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(101)
					while(((_g < _g1->length))){
						HX_STACK_LINE(101)
				...
				if ((hasMain)){
					HX_STACK_LINE(111)
					::Reflect_obj::callMethod(hx::ClassOf< ::spinehx::AnimationStateTest >(),::Reflect_obj::field(hx::ClassOf< ::spinehx::AnimationStateTest >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(116)
		...
		HX_STACK_LINE(67)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)320,(int)480,(int)200,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("spinehx - AnimationStateTest"),null(),null());
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMain::applyScale","ApplicationMain.hx",150);
		HX_STACK_ARG(_,"_");
		HX_STACK_LINE(152)
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	HX_STACK_PUSH("ApplicationMain::getAsset","ApplicationMain.hx",198);
