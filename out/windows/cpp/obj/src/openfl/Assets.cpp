...
::flash::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("Assets::getMovieClip","openfl/Assets.hx",292);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(294)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(298)
	...
	if ((::nme::AssetData_obj::library->exists(libraryName))){
		...
		HX_STACK_LINE(345)
		::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),347,HX_CSTRING("openfl.Assets"),HX_CSTRING("getMovieClip")));
	}
	HX_STACK_LINE(353)
	return null();
}
...
::flash::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","openfl/Assets.hx",364);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(366)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(370)
	...
	HX_STACK_LINE(394)
	::haxe::Log_obj::trace(((HX_CSTRING("[openfl.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),394,HX_CSTRING("openfl.Assets"),HX_CSTRING("getSound")));
	HX_STACK_LINE(398)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","openfl/Assets.hx",409);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(411)
...
Array< ::String > Assets_obj::get_id( ){
	HX_STACK_PUSH("Assets::get_id","openfl/Assets.hx",471);
	HX_STACK_LINE(473)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(475)
...
::haxe::ds::StringMap Assets_obj::get_library( ){
	HX_STACK_PUSH("Assets::get_library","openfl/Assets.hx",492);
	HX_STACK_LINE(494)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(498)
...
::haxe::ds::StringMap Assets_obj::get_path( ){
	HX_STACK_PUSH("Assets::get_path","openfl/Assets.hx",509);
	HX_STACK_LINE(511)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(515)
...
::haxe::ds::StringMap Assets_obj::get_type( ){
	HX_STACK_PUSH("Assets::get_type","openfl/Assets.hx",526);
	HX_STACK_LINE(528)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(532)
